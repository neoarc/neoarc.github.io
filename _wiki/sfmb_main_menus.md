...
The following menus provide different ways to select and play stages. They are grouped here as play menus rather than separate game modes.
...
Single Stage plays an individual stage saved in the game's local map folders. It is mainly used for playing locally created or manually placed stage files.
...
The Inventory shows the items owned by the user's account.

> **TODO**
<!-- Document every current item type, its quantity or state, and how each item is obtained and used. -->
...
Credits shows information about the people and resources involved in the project.

> **TODO**
<!-- Document the Credits screen structure and the types of contributors listed there. -->
...
* [[sfmb_stage_contests]]{Stage Contests} — Community contests and their winning levels.
